...
//这个类复制了Main 修改了 Search函数 为了返回计算的数据 加上了 返回类型
...
//            data1.setId("A");
//            data1.setInformation("A指标年度最小值是：" + min_A + "      A指标年度最小值所在月份是：" + min_A_month + "月");
            ...
            information = "对综合效能指标A最低值影响最大的C级指标是：" +feature_name_C[index_min_A_Cfeature];
            ...
            data1 = new Data_01("B","B1指标年度最小值是：" + min_B1 + "      B1指标年度最小值所在月份是：" + min_B1_month + "月");
            data01List.add(data1);
